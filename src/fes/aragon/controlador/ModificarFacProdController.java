...
public class ModificarFacProdController implements Initializable {
    ...
    @FXML
    private TableColumn<Productos, String> productoPrecio;
    ...
    void guardarAccion(ActionEvent event) {
    	try {
			...
			cnn.modificarFacProd(facprod);
			
			alerta.setHeaderText("Factura producto modificada");
    		alerta.setContentText("La factura producto se modifico correctamente");
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		this.tblTablaFactura.getSelectionModel().selectedItemProperty().addListener((obj, oldSeleccion, newSeleccion) -> {
			if (newSeleccion != null) {
				...
				txtReferencia.setText(fac.getReferencia());
				txtFecha.setText(fac.getFecha().format(formatter));
				txtNombreCliente.setText(fac.getNombreCliente());
				txtApellidoCliente.setText(fac.getApellidoCliente());
	...
	public void modificarFacProd(FacProd facprod) {
    	this.facprod = facprod;
    	txtReferencia.setText(facprod.getReferencia());
    	txtFecha.setText(facprod.getFecha().format(formatter));
		txtNombreCliente.setText(facprod.getFactura().getNombreCliente());
		txtApellidoCliente.setText(facprod.getFactura().getApellidoCliente());
		txtNombre.setText(facprod.getProducto().getNombre());
		txtPrecio.setText(String.valueOf(facprod.getPrecioProd()));
    	this.txtCantidad.setText(String.valueOf(facprod.getCantidad()));
    }
